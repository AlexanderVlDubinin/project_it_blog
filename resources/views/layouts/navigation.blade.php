            ...
            <div class="flex justify-between items-center">
                @auth
                    ...
                    <div class="flex items-center" >
                        ...
                        <button class="notifications-button-icon relative p-2 text-gray-400 hover:text-gray-300 focus:outline-none">
                            <!-- Icon Heroicons (Bell) -->
                            ...
                            @if($unreadNotificationsCount > 0)
                                <span class="badge-notifications-number absolute top-0 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white bg-red-500 rounded-full transform translate-x-1/3 -translate-y-1/3">
