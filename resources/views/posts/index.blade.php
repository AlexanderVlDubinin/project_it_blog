                ...
                @forelse ($posts as $post)
                    <div class="p-2">
                        <div class="mt-4 border border-border border-gray-700 dark:border-gray-300 bg-white dark:bg-gray-800 rounded-lg px-4 py-2 h-full flex flex-col justify-between">
                            ...
                            @endif
                            <div class="mt-4 flex items-center justify-between w-full gap-2">
                                <div>
                                    <div class="flex items-center justify-between w-full gap-4 text-gray-600 dark:text-gray-400">
                                        <i>
                                            <b>Authored by</b>
                                ...
                                <div class="flex flex-col items-stretch">
                                    <a href="{{ route('posts.edit', $post->id) }}" class="mt-1 w-full">
                                        <button class="w-full flex items-center justify-between border border-border border-gray-700 dark:border-gray-300 bg-indigo-500 rounded-lg px-4 py-1 button-back cursor-pointer">
                                    ...
                                    <button form="remove-post-form_{{$post->id}}" class="mt-1 w-full border border-border border-gray-700 dark:border-gray-300 rounded-lg px-4 py-1 bg-[oklch(0.45_0.25_25)] cursor-pointer flex inline-flex text-nowrap">
